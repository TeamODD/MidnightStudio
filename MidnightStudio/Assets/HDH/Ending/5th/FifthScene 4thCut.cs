...
public class FifthScene_4thCut : MonoBehaviour
{
    ...
    private IEnumerator Production_Start_Coroutine()
    {
        ...
        Obj_UP[1].Position("Lerp", 7.5f, new Vector3(-5f, 0.32f, 0f), new Vector3(-7f, 0.38f, 0f));
        Obj_UP[1].Scale("Lerp", 7.5f, new Vector3(0.9275f, 0.9275f, 0f), new Vector3(1.1f, 1.1f, 0f));

        Obj_UP[2].Position("Lerp", 7.5f, new Vector3(2.27f, 0.04f, 0f), new Vector3(0f, -0.4f, 0f));
        Obj_UP[2].Scale("Lerp", 7.5f, new Vector3(0.9275f, 0.9275f, 0f), new Vector3(1f, 1f, 0f));
