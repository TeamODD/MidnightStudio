...
public class FifthScene_6thCut : MonoBehaviour
{
    ...
    private IEnumerator Production_Start_Coroutine()
    {
        ...
        A.Coloring("Instant", 0f, new Color(0f, 0f, 0f, 0f), new Color(0f, 0f, 0f, 1f));
        yield return new WaitForSeconds(0.1f);

        Scene_Manager.Shake.Production_Start(15);

        A.Coloring("Instant", 0f, new Color(0f, 0f, 0f, 1f), new Color(0.98f, 0.46f, 0.14f, 1f));
        Scene_Manager.AudioPlayer.PlaySE(Clips[0]);
        yield return new WaitForSeconds(0.05f);
        

        A.Coloring("Instant", 0f, new Color(0f, 0f, 0f, 1f), new Color(0f, 0f, 0f, 1f));
